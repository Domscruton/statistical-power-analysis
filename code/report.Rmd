...
kable(dtMurders[, .(MurderRate = mean(Rate), Variance = var(Rate)), 
                by = region], format = "rmarkdown")
```
...
#increasing size
n2 <- SimulationFun(N = 2, K = 100, R = 100)
n3 <- SimulationFun(N = 3, K = 200, R = 500)
n4 <- SimulationFun(N = 4, K = 200, R = 500)
n5 <- SimulationFun(N = 5, K = 200, R = 500)
n10 <- SimulationFun(N = 10, K = 200, R = 500)
n20 <- SimulationFun(N = 20, K = 200, R = 500)
n50 <- SimulationFun(N = 50, K = 200, R = 500)
n100 <- SimulationFun(N = 100, K= 200, R = 500)
n200 <- SimulationFun(N = 200, K = 200, R = 500)
n500 <- SimulationFun(N = 500, K = 200, R = 500)
n1000 <- SimulationFun(N = 1000, K = 200, R = 500)
